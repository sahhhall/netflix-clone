  ...
  return (
    <div className=" w-full h-[550px] lg:h[850px]">
      <div className="w-full h-full">
        <div className="absolute w-full  h-[550px] lg:h[850px] ">
          <img
          ...
          <div className="absolute w-full top-[20%] lg:top-[35%] md:p-8 p-4 ">
            ...
            <div className="mt-8 mb-4">
              <button className=" capitalize border border-gray-300 py-2 px-3 bg-white text-black">
                play
              </button>
              <button className=" capitalize border border-gray-300 py-2 px-3 ml-4">
                watch later
              </button>
            </div>
